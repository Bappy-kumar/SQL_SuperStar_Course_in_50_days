...
-- numbers of records in customers table
...
select count(manager_id) from employees where salary > 50000;
...
-- five employees with the maximum salary
select * from employees order by salary desc limit 5;

select * from employees order by salary desc, department_id limit 5;
