/* DDL - create, alter, drop
  ...
  */
  ...
  ## analyticsx
  /* I want to give access to customers table (but do not want to give
...
customer_zipcode from customers;
...
(100, 'Tina Chartreuse', 'tina.chartreuse100@gmail.com', '123-555-0100', 'Spokane', 99000.00);
  ...
  grant delete, drop on retail_db.employees To 'analyticsx'@'localhost';
...
(100, 'Tina Chartreuse', 'tina.chartreuse100@gmail.com', '123-555-0100', 'Spokane', 99000.00);
 ...
 select * from employees;
  ...
  /* if you perform any DML operation then your transaction is 
  in open state
